...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--output-dir", default="/scratch/mariamma/coco/checkpoints/single/", type=str, help="path to save outputs")
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        coco_evaluator = evaluate(model, data_loader_test, args.corruption, args.severity, args.output_dir, device=device)
...
def write_statsto_file(epoch, coco_evaluator):
    with open("/scratch/mariamma/coco/checkpoints/single/res.txt", "a") as f:
        f.write("\n\n Epoch {}".format(epoch))
        for x in ["bbox", "segm"]:
            f.write("\nIoU metric: {}".format(x))
