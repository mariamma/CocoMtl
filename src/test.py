...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--output-dir", default="/scratch/mariamma/coco/checkpoints/", type=str, help="path to save outputs")
    ...
    parser.add_argument(
        "--corruption", default="gaussian_blur", type=str, help="type of image corruption to be applied"
    )
...
def main(args):
    ...
    if args.test_only:
        print("Test only...")
        checkpoint = torch.load(os.path.join(args.output_dir, 'model_20.pth'))
