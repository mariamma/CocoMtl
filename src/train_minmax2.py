...
from minmax_engine2 import evaluate, train_one_epoch
...
def write_statsto_file(epoch, coco_evaluator):
    with open("/scratch/mariamma/coco/checkpoints/minmax2/res_minmax2.txt", "a") as f:
        f.write("\n\n Epoch {}".format(epoch))
        for x in ["bbox", "segm"]:
            f.write("\nIoU metric: {}".format(x))
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--output-dir", default="/scratch/mariamma/coco/checkpoints/minmax2/", type=str, help="path to save outputs")
